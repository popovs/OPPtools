...
```{r ra_plot, fig.height = 3, fig.cap = "Inclusion rate as a function of sample size. The solid line shows the result of non-linear regression, the grey shaded area shows range of inclusion values calculated by subsampling iterations. The dashed horizontal line shows the target asymptote, which is determined be the desired utilization distribution."}
