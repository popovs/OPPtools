...
```{r plot KBA, fig.height=5, fig.cap = paste("Map showing the estimated distribution of birds at sea around the", unique(dat$study_site), "breeding colony. Polygon shading shows the minimum estimated number of individuals from the colony expected to use this area during the", tolower(params$stage), "stage of breeding. Polygon outline indicates the minimum percent of the colony population expected to use this area during the", tolower(params$stage), "stage of breeding.")}
