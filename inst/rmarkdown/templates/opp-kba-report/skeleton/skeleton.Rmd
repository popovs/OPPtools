...
metadata <- list("smoother" = params$kernelSmoother, 
                 ...
                 "meta_ss" = "Sample size metadata | repr = representativeness (%) of GPS kernels vs total population's space use; total_ss = total # of tracks used to generate this shapefile; years = # years of tracking data used to generate shapefile",
                 ...
                 "meta_lh" = "Life history metadata | species = species; site = colony/tagging site; stage = tagged animal life stage; tot_pairs = total # of breeding pairs at colony (i.e. colony population / 2)"
                 )
...
```{r plot KBA, fig.height=5, fig.cap = paste("Map showing the estimated distribution of birds at sea around the", unique(dat$study_site), "breeding colony. Polygon shading shows the minimum estimated number of individuals from the colony expected to use this area during", tolower(params$stage), "stage of breeding. Polygon outline indicates the minimum percent of the colony population expected to use this area during", tolower(params$stage), "stage of breeding.")}
